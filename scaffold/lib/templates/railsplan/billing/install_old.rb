...
after_bundle do
  ...
  say_status :railsplan_billing, "✅ Enhanced plan model with metadata and feature limits"
  say_status :railsplan_billing, "✅ Improved webhook retry logic with error classification"
  say_status :railsplan_billing, "✅ Added admin UI for plan management"
  say_status :railsplan_billing, "✅ Comprehensive edge case tests included"
  say_status :railsplan_billing, ""
  say_status :railsplan_billing, "Next steps:"
  say_status :railsplan_billing, "1. Run 'rails db:migrate' to create billing tables"
  say_status :railsplan_billing, "2. Configure your Stripe API keys in .env"
  say_status :railsplan_billing, "3. Set up webhook endpoints in your Stripe dashboard"
  say_status :railsplan_billing, "4. Access admin plan management at /admin/plans"
  say_status :railsplan_billing, "5. Add admin? method to User model for admin access"
end