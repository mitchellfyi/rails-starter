...
# RailsPlan User Settings module installer for the Rails SaaS starter template.
...
unless File.exist?('app/domains/auth')
  say_status :error, "Auth module is required. Please install it first with: bin/railsplan add auth", :red
  exit 1
end
