...
# RailsPlan Docs module installer for the Rails SaaS starter template.
  ...
  create_file 'app/domains/docs/app/services/documentation_generator.rb', <<~'RUBY'
    class DocumentationGenerator
      ...
      def generate_module_docs
        ...
        modules_path = Rails.root.join('lib/templates/railsplan')
        return unless Dir.exist?(modules_path)

        module_index = ["# RailsPlan Modules\n\n"]
        module_index << "This application uses the following RailsPlan modules:\n\n"
      ...
      def generate_setup_guide
        ...
        setup_guide = <<~'MARKDOWN'
          ...
          Use the RailsPlan CLI to add features to your application:
          ...
          2. Add or modify modules using `bin/railsplan`
      ...
      def generate_changelog
        ...
        changelog = <<~'MARKDOWN'
          ...
          - RailsPlan CLI for modular feature management
          ...
          - RailsPlan modular architecture
  ...
  create_file 'docs/index.html', <<~'HTML'
    ...
    <body>
        ...
        <div class="docs-grid">
            ...
            <div class="doc-card">
                <h3>🧩 Modules</h3>
                <p>Learn about available RailsPlan modules and their features.</p>
        ...
        <footer style="text-align: center; color: #6b7280; margin-top: 3rem;">
            <p>Generated by RailsPlan Docs Module</p>
        </footer>
    </body>
    </html>
  HTML
