...
say_status :railsplan_admin, "Installing Admin Panel module"
...
after_bundle do
  ...
  say_status :railsplan_admin, "Admin panel with user activity feed installed successfully!"
  say_status :railsplan_admin, "New Features Added:"
  say_status :railsplan_admin, "• User activity feed for end users at /activity"
  say_status :railsplan_admin, "• Enhanced audit logs with filtering and CSV export"
  say_status :railsplan_admin, "• Timeline UI components for activity display"
  say_status :railsplan_admin, "• Admin user activities dashboard at /admin/user_activities"
  say_status :railsplan_admin, ""
  say_status :railsplan_admin, "Next steps:"
  say_status :railsplan_admin, "1. Run: rails db:migrate"
  say_status :railsplan_admin, "2. Create an admin user: User.create!(email: 'admin@example.com', password: 'password', admin: true)"
  say_status :railsplan_admin, "3. Visit /admin to access the admin panel"
  say_status :railsplan_admin, "4. Visit /activity to see the user activity feed"
  say_status :railsplan_admin, "5. Configure Sidekiq and Flipper credentials in Rails credentials"
  say_status :railsplan_admin, "6. Include ActivityTrackable concern in models you want to track"
end
