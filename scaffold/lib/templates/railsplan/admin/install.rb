...
after_bundle do
  ...
  say_status :railsplan_admin, "✅ Admin Panel module installed successfully!"
  say_status :railsplan_admin, "📝 Run 'rails db:migrate' to apply admin database changes"
  say_status :railsplan_admin, "🔧 Configure admin settings in config/initializers/admin.rb"
  say_status :railsplan_admin, "🌟 Access admin panel at /admin (requires admin user)"
end