...
after_bundle do
  ...
  say_status :synth_cms, "✅ CMS/Blog Engine module installed successfully!"
  say_status :synth_cms, "📝 Run 'rails db:migrate' to apply CMS database changes"
  say_status :synth_cms, "📖 Access CMS admin at /cms/"
  say_status :synth_cms, "🌐 Public blog available at /blog/"
end