...
say_status :synth_api, "Installing API module"
...
after_bundle do
  ...
  say_status :synth_api, "✅ API module installed successfully!"
  say_status :synth_api, "📖 Access API documentation at /api-docs"
  say_status :synth_api, "🔑 Configure API authentication in config/initializers/api.rb"
  say_status :synth_api, "📊 API endpoints available at /api/v1/"
end