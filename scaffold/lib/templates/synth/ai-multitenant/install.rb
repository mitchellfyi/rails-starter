...
say_status :synth_ai_multitenant, "Installing AI Multitenant module with complete workspace isolation"
...
after_bundle do
  ...
  say_status :synth_ai_multitenant, "AI Multitenant system installed successfully!"
  say_status :synth_ai_multitenant, ""
  say_status :synth_ai_multitenant, "Next steps after installation:"
  say_status :synth_ai_multitenant, "1. Run 'rails db:migrate' to create database tables"
  say_status :synth_ai_multitenant, "2. Run 'rails db:seed' to set up default OpenAI provider"
  say_status :synth_ai_multitenant, "3. Set OPENAI_API_KEY in your environment"
  say_status :synth_ai_multitenant, "4. Visit /ai/playground to test the AI playground"
  say_status :synth_ai_multitenant, "5. Run 'whenever --update-crontab' to enable usage summaries"
  say_status :synth_ai_multitenant, "6. Run 'rails test' to verify everything works"
end