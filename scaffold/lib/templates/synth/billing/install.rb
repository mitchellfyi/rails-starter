...
after_bundle do
  ...
  say_status :synth_billing, "📝 Run 'rails db:migrate' to apply billing database changes"
  say_status :synth_billing, "🔧 Configure Stripe keys in your environment variables"
  say_status :synth_billing, "💳 Set up Stripe webhook endpoint at /billing/webhook"
end