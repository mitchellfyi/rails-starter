...
RSpec.describe TestFeatureService do
  ...
  describe '#create_item' do
    ...
    context 'with valid attributes' do
      ...
      it 'returns the created item' do
        ...
        expect(item).to be_a(TestFeatureItem)
    ...
    context 'with invalid attributes' do
      ...
      it 'does not create an item' do
        ...
        }.not_to change(TestFeatureItem, :count)
      end
  ...
  describe '#update_item' do
    let(:item) { create(:test_feature_item, user: user, name: 'Original Name') }
  ...
  describe '#delete_item' do
    let(:item) { create(:test_feature_item, user: user) }
